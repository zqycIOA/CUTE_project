function[PS , mask] = calc_phase_shift_Hermitian_dw_CMA_eikonal_iter_CMAvec(xvec , zvec , Cmap , rf_frame1 , ...
...
[I1 , mask1] = mk_dw_rf_CMA_image_eikonal_CMAvec(xvec , zvec , xvec , zvec , Cmap , emitx1 , rf_signal1 , ...
...
[I2 , mask2] = mk_dw_rf_CMA_image_eikonal_CMAvec(xvec , zvec , xvec , zvec , Cmap , emitx2 , rf_signal2 , ...
    t_array - 2/5e6, axiscorrx , CMAvec);
nanind = isnan(I2);
I2(nanind) = 0;
inan = isnan(I2);
